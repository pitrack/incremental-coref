...
# encoders = ["da"]
layers = [25]
num_samples = [0, 10, 25, 50, 100, 250, 359]
GOLD = ["true", "false"]
trials = [0]
GPUs = [4, 5, 6, 7]

log_location = "onml_curve_ar_q1_"
job_names = [(f"onml_curve_ar_{encoder}_{layers}_{num_samples}_{trial}{'_gold' if gold == 'true' else ''}", gold)
